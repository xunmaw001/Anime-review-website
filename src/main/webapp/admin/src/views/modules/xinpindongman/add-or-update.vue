        ...
        <div v-else>
          <el-form-item v-if="ruleForm.tupian" label="图片" prop="tupian">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.tupian.split(',')" :src="item" width="100" height="100">
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="动漫作者" prop="dongmanzuozhe">
          <el-input v-model="ruleForm.dongmanzuozhe" 
              placeholder="动漫作者" clearable  :readonly="ro.dongmanzuozhe"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="动漫作者" prop="dongmanzuozhe">
              <el-input v-model="ruleForm.dongmanzuozhe" 
                placeholder="动漫作者" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="24">  
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.shipinjieshao" label="视频介绍" prop="shipinjieshao">
            <el-button type="text" size="small" @click="download(ruleForm.shipinjieshao)">预览</el-button>
                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                    <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="动漫详情" prop="dongmanxiangqing">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.dongmanxiangqing" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.dongmanxiangqing" label="动漫详情" prop="dongmanxiangqing">
                    <span v-html="ruleForm.dongmanxiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.shipinjieshao = true;
            continue;
	            	            ...
	            	            if(o=='dongmanxiangqing'){
            this.ruleForm.dongmanxiangqing = obj[o];
	    this.ro.dongmanxiangqing = true;
            continue;
          }
	            	            if(o=='clicktime'){
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `xinpindongman/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xinpindongmanCrossAddOrUpdateFlag = false;
                  this.parent.search();
